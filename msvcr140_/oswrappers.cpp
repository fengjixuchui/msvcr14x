...
extern "C"
{
	void __cdecl _o_abort()
	{
		return __crt_state_management::wrapped_invoke_void(abort);
	}
	int __cdecl _o__access(char const * const path, int const access_mode)
	{
		return __crt_state_management::wrapped_invoke(_access, path, access_mode);
	}
	errno_t __cdecl _o__access_s(char const * const path, int const access_mode)
	{
		return __crt_state_management::wrapped_invoke(_access_s, path, access_mode);
	}
	FILE * __cdecl _o___acrt_iob_func(unsigned const id)
	{
		return __crt_state_management::wrapped_invoke(__acrt_iob_func, id);
	}
	void __cdecl _o__aligned_free(void * const block)
	{
		return __crt_state_management::wrapped_invoke_void(_aligned_free, block);
	}
	void * __cdecl _o__aligned_malloc(size_t const size, size_t const alignment)
	{
		return __crt_state_management::wrapped_invoke(_aligned_malloc, size, alignment);
	}
	size_t __cdecl _o__aligned_msize(void * const block, size_t const alignment, size_t const offset)
	{
		return __crt_state_management::wrapped_invoke(_aligned_msize, block, alignment, offset);
	}
	void * __cdecl _o__aligned_offset_malloc(size_t const size, size_t const alignment, size_t const offset)
	{
		return __crt_state_management::wrapped_invoke(_aligned_offset_malloc, size, alignment, offset);
	}
	void * __cdecl _o__aligned_offset_realloc(void * const block, size_t const size, size_t const alignment, size_t const offset)
	{
		return __crt_state_management::wrapped_invoke(_aligned_offset_realloc, block, size, alignment, offset);
	}
	void * __cdecl _o__aligned_offset_recalloc(void * const block, size_t const count, size_t const size, size_t const alignment, size_t const offset)
	{
		return __crt_state_management::wrapped_invoke(_aligned_offset_recalloc, block, count, size, alignment, offset);
	}
	void * __cdecl _o__aligned_realloc(void * const block, size_t const size, size_t const alignment)
	{
		return __crt_state_management::wrapped_invoke(_aligned_realloc, block, size, alignment);
	}
	void * __cdecl _o__aligned_recalloc(void * const block, size_t const count, size_t const size, size_t const alignment)
	{
		return __crt_state_management::wrapped_invoke(_aligned_recalloc, block, count, size, alignment);
	}
	char * __cdecl _o_asctime(tm const * const tm_value)
	{
		return __crt_state_management::wrapped_invoke(asctime, tm_value);
	}
	errno_t __cdecl _o_asctime_s(char * const buffer, size_t const size_in_chars, tm const * const tm_value)
	{
		return __crt_state_management::wrapped_invoke(asctime_s, buffer, size_in_chars, tm_value);
	}
	int __cdecl _o__atodbl(_CRT_DOUBLE * const result, char * const string)
	{
		return __crt_state_management::wrapped_invoke(_atodbl, result, string);
	}
	int __cdecl _o__atodbl_l(_CRT_DOUBLE * const result, char * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atodbl_l, result, string, locale);
	}
	double __cdecl _o_atof(char const * const string)
	{
		return __crt_state_management::wrapped_invoke(atof, string);
	}
	double __cdecl _o__atof_l(char const * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atof_l, string, locale);
	}
	int __cdecl _o__atoflt(_CRT_FLOAT * const result, char const * const string)
	{
		return __crt_state_management::wrapped_invoke(_atoflt, result, string);
	}
	int __cdecl _o__atoflt_l(_CRT_FLOAT * const result, char const * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atoflt_l, result, string, locale);
	}
	int __cdecl _o_atoi(char const * const string)
	{
		return __crt_state_management::wrapped_invoke(atoi, string);
	}
	int __cdecl _o__atoi_l(char const * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atoi_l, string, locale);
	}
	__int64 __cdecl _o__atoi64(char const * const string)
	{
		return __crt_state_management::wrapped_invoke(_atoi64, string);
	}
	__int64 __cdecl _o__atoi64_l(char const * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atoi64_l, string, locale);
	}
	long __cdecl _o_atol(char const * const string)
	{
		return __crt_state_management::wrapped_invoke(atol, string);
	}
	long __cdecl _o__atol_l(char const * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atol_l, string, locale);
	}
	int __cdecl _o__atoldbl(_LDOUBLE * const result, char * const string)
	{
		return __crt_state_management::wrapped_invoke(_atoldbl, result, string);
	}
	int __cdecl _o__atoldbl_l(_LDOUBLE * const result, char * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atoldbl_l, result, string, locale);
	}
	long long __cdecl _o_atoll(char const * const string)
	{
		return __crt_state_management::wrapped_invoke(atoll, string);
	}
	long long __cdecl _o__atoll_l(char const * const string, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_atoll_l, string, locale);
	}
	void __cdecl _o__beep(unsigned const frequency, unsigned const duration)
	{
		return __crt_state_management::wrapped_invoke_void(_beep, frequency, duration);
	}
	uintptr_t __cdecl _o__beginthread(_beginthread_proc_type const procedure, unsigned int const stack_size, void * const context)
	{
		return __crt_state_management::wrapped_invoke(_beginthread, procedure, stack_size, context);
	}
	uintptr_t __cdecl _o__beginthreadex(void * const security_descriptor, unsigned int const stack_size, _beginthreadex_proc_type const procedure, void * const context, unsigned int const creation_flags, unsigned int * const thread_id_result)
	{
	...
	errno_t __cdecl _o_rand_s(unsigned int * const result)
	{
		return __crt_state_management::wrapped_invoke(rand_s, result);
	}
	int __cdecl _o__read(int const fh, void * const buffer, unsigned const buffer_size)
	{
		return __crt_state_management::wrapped_invoke(_read, fh, buffer, buffer_size);
	}
	void * __cdecl _o_realloc(void * const block, size_t const size)
	{
		return __crt_state_management::wrapped_invoke(realloc, block, size);
	}
	void * __cdecl _o__realloc_base(void * const block, size_t const size)
	{
		return __crt_state_management::wrapped_invoke(_realloc_base, block, size);
	}
	void * __cdecl _o__recalloc(void * const block, size_t const count, size_t const size)
	{
		return __crt_state_management::wrapped_invoke(_recalloc, block, count, size);
	}
	int __cdecl _o__register_onexit_function(_onexit_table_t * const table, _onexit_t const function)
	{
		return __crt_state_management::wrapped_invoke(_register_onexit_function, table, function);
	}
	int __cdecl _o_remove(char const * const path)
	{
		return __crt_state_management::wrapped_invoke(remove, path);
	}
	int __cdecl _o_rename(char const * const old_name, char const * const new_name)
	{
		return __crt_state_management::wrapped_invoke(rename, old_name, new_name);
	}
	int __cdecl _o__resetstkoflw()
	{
		return __crt_state_management::wrapped_invoke(_resetstkoflw);
	}
	void __cdecl _o_rewind(FILE * const public_stream)
	{
		return __crt_state_management::wrapped_invoke_void(rewind, public_stream);
	}
	int __cdecl _o__rmdir(char const * const path)
	{
		return __crt_state_management::wrapped_invoke(_rmdir, path);
	}
	int __cdecl _o__rmtmp()
	{
		return __crt_state_management::wrapped_invoke(_rmtmp);
	}
	void __cdecl _o__searchenv(char const * const file_name, char const * const environment_variable, char * const result_buffer)
	{
		return __crt_state_management::wrapped_invoke_void(_searchenv, file_name, environment_variable, result_buffer);
	}
	errno_t __cdecl _o__searchenv_s(char const * const file_name, char const * const environment_variable, char * const result_buffer, size_t const result_count)
	{
		return __crt_state_management::wrapped_invoke(_searchenv_s, file_name, environment_variable, result_buffer, result_count);
	}
	int __cdecl _o__seh_filter_dll(unsigned long const xcptnum, PEXCEPTION_POINTERS const pxcptinfoptrs)
	{
		return __crt_state_management::wrapped_invoke(_seh_filter_dll, xcptnum, pxcptinfoptrs);
	}
	int __cdecl _o__seh_filter_exe(unsigned long const xcptnum, PEXCEPTION_POINTERS const pxcptinfoptrs)
	{
		return __crt_state_management::wrapped_invoke(_seh_filter_exe, xcptnum, pxcptinfoptrs);
	}
	unsigned int __cdecl _o__set_abort_behavior(unsigned int flags, unsigned int mask)
	{
		return __crt_state_management::wrapped_invoke(_set_abort_behavior, flags, mask);
	}
	void __cdecl _o__set_app_type(_crt_app_type const new_app_type)
	{
		return __crt_state_management::wrapped_invoke_void(_set_app_type, new_app_type);
	}
	errno_t _o__set_doserrno(unsigned long const value)
	{
		return __crt_state_management::wrapped_invoke(_set_doserrno, value);
	}
	errno_t _o__set_errno(int const value)
	{
		return __crt_state_management::wrapped_invoke(_set_errno, value);
	}
	errno_t __cdecl _o__set_fmode(int const mode)
	{
		return __crt_state_management::wrapped_invoke(_set_fmode, mode);
	}
	_invalid_parameter_handler __cdecl _o__set_invalid_parameter_handler(_invalid_parameter_handler const new_handler)
	{
		return __crt_state_management::wrapped_invoke(_set_invalid_parameter_handler, new_handler);
	}
	_PNH __cdecl _o__set_new_handler(_PNH new_handler)
	{
		return __crt_state_management::wrapped_invoke(_set_new_handler, new_handler);
	}
	int __cdecl _o__set_new_mode(int const mode)
	{
		return __crt_state_management::wrapped_invoke(_set_new_mode, mode);
	}
	terminate_handler __cdecl _o_set_terminate(terminate_handler const new_handler)
	{
		return __crt_state_management::wrapped_invoke(set_terminate, new_handler);
	}
	_invalid_parameter_handler __cdecl _o__set_thread_local_invalid_parameter_handler(_invalid_parameter_handler const new_handler)
	{
		return __crt_state_management::wrapped_invoke(_set_thread_local_invalid_parameter_handler, new_handler);
	}
	void __cdecl _o_setbuf(FILE * const stream, char * const buffer)
	{
		return __crt_state_management::wrapped_invoke_void(setbuf, stream, buffer);
	}
	void __cdecl _o__seterrormode(int const mode)
	{
		return __crt_state_management::wrapped_invoke_void(_seterrormode, mode);
	}
	char * __cdecl _o_setlocale(int _category, char const * _locale)
	{
		return __crt_state_management::wrapped_invoke(setlocale, _category, _locale);
	}
	int __cdecl _o__setmbcp(int const codepage)
	{
		return __crt_state_management::wrapped_invoke(_setmbcp, codepage);
	}
	int __cdecl _o__setmode(int const fh, int const mode)
	{
		return __crt_state_management::wrapped_invoke(_setmode, fh, mode);
	}
	unsigned __cdecl _o__setsystime(tm * const source, unsigned const milliseconds)
	{
		return __crt_state_management::wrapped_invoke(_setsystime, source, milliseconds);
	}
	int __cdecl _o_setvbuf(FILE * const public_stream, char * const buffer, int const type, size_t const buffer_size_in_bytes)
	{
		return __crt_state_management::wrapped_invoke(setvbuf, public_stream, buffer, type, buffer_size_in_bytes);
	}
	void __cdecl _o__sleep(unsigned long duration)
	{
		return __crt_state_management::wrapped_invoke_void(_sleep, duration);
	}
	int __cdecl _o__sopen(char const * const path, int const oflag, int const shflag, const int _PMode)
	{
		return __crt_state_management::wrapped_invoke(_sopen, path, oflag, shflag, _PMode);
	}
	errno_t __cdecl _o__sopen_dispatch(char const * const path, int const oflag, int const shflag, int const pmode, int * const pfh, int const secure)
	{
		return __crt_state_management::wrapped_invoke(_sopen_dispatch, path, oflag, shflag, pmode, pfh, secure);
	}
	errno_t __cdecl _o__sopen_s(int * const pfh, char const * const path, int const oflag, int const shflag, int const pmode)
	{
		return __crt_state_management::wrapped_invoke(_sopen_s, pfh, path, oflag, shflag, pmode);
	}
	intptr_t __cdecl _o__spawnv(int const mode, char const * const file_name, char const * const * const arguments)
	{
		return __crt_state_management::wrapped_invoke(_spawnv, mode, file_name, arguments);
	}
	intptr_t __cdecl _o__spawnve(int const mode, char const * const file_name, char const * const * const arguments, char const * const * const environment)
	{
		return __crt_state_management::wrapped_invoke(_spawnve, mode, file_name, arguments, environment);
	}
	intptr_t __cdecl _o__spawnvp(int const mode, char const * const file_name, char const * const * const arguments)
	{
		return __crt_state_management::wrapped_invoke(_spawnvp, mode, file_name, arguments);
	}
	intptr_t __cdecl _o__spawnvpe(int const mode, char const * const file_name, char const * const * const arguments, char const * const * const environment)
	{
		return __crt_state_management::wrapped_invoke(_spawnvpe, mode, file_name, arguments, environment);
	}
	void __cdecl _o__splitpath(char const * const path, char * const drive, char * const directory, char * const file_name, char * const extension)
	{
		return __crt_state_management::wrapped_invoke_void(_splitpath, path, drive, directory, file_name, extension);
	}
	errno_t __cdecl _o__splitpath_s(char const * const path, char * const drive, size_t const drive_count, char * const directory, size_t const directory_count, char * const file_name, size_t const file_name_count, char * const extension, size_t const extension_count)
	{
	...
	void __cdecl _o_srand(unsigned int const seed)
	{
		return __crt_state_management::wrapped_invoke_void(srand, seed);
	}
	int __cdecl _o__stat32(char const * const path, struct _stat32 * const result)
	{
		return __crt_state_management::wrapped_invoke(_stat32, path, result);
	}
	int __cdecl _o__stat32i64(char const * const path, struct _stat32i64 * const result)
	{
		return __crt_state_management::wrapped_invoke(_stat32i64, path, result);
	}
	int __cdecl _o__stat64(char const * const path, struct _stat64 * const result)
	{
		return __crt_state_management::wrapped_invoke(_stat64, path, result);
	}
	int __cdecl _o__stat64i32(char const * const path, struct _stat64i32 * const result)
	{
		return __crt_state_management::wrapped_invoke(_stat64i32, path, result);
	}
	int __cdecl _o___stdio_common_vfprintf(unsigned __int64 const options, FILE * const stream, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfprintf, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfprintf_p(unsigned __int64 const options, FILE * const stream, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfprintf_p, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfprintf_s(unsigned __int64 const options, FILE * const stream, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfprintf_s, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfscanf(unsigned __int64 const options, FILE * const stream, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfscanf, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfwprintf(unsigned __int64 const options, FILE * const stream, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfwprintf, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfwprintf_p(unsigned __int64 const options, FILE * const stream, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfwprintf_p, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfwprintf_s(unsigned __int64 const options, FILE * const stream, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfwprintf_s, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vfwscanf(unsigned __int64 const options, FILE * const stream, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vfwscanf, options, stream, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vsnprintf_s(unsigned __int64 const options, char * const buffer, size_t const buffer_count, size_t const max_count, char const * const format, _locale_t const locale, va_list const arglist)
	{
	...
	int __cdecl _o___stdio_common_vsnwprintf_s(unsigned __int64 const options, wchar_t * const buffer, size_t const buffer_count, size_t const max_count, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
	...
	int __cdecl _o___stdio_common_vsprintf(unsigned __int64 const options, char * const buffer, size_t const buffer_count, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vsprintf, options, buffer, buffer_count, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vsprintf_p(unsigned __int64 const options, char * const buffer, size_t const buffer_count, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vsprintf_p, options, buffer, buffer_count, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vsprintf_s(unsigned __int64 const options, char * const buffer, size_t const buffer_count, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vsprintf_s, options, buffer, buffer_count, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vsscanf(unsigned __int64 const options, char const * const buffer, size_t const buffer_count, char const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vsscanf, options, buffer, buffer_count, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vswprintf(unsigned __int64 const options, wchar_t * const buffer, size_t const buffer_count, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vswprintf, options, buffer, buffer_count, format, locale, arglist);
	}
	int __cdecl _o___stdio_common_vswprintf_p(unsigned __int64 const options, wchar_t * const buffer, size_t const buffer_count, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
	...
	int __cdecl _o___stdio_common_vswprintf_s(unsigned __int64 const options, wchar_t * const buffer, size_t const buffer_count, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
	...
	int __cdecl _o___stdio_common_vswscanf(unsigned __int64 const options, wchar_t const * const buffer, size_t const buffer_count, wchar_t const * const format, _locale_t const locale, va_list const arglist)
	{
		return __crt_state_management::wrapped_invoke(__stdio_common_vswscanf, options, buffer, buffer_count, format, locale, arglist);
	}
	errno_t __cdecl _o_strcat_s(char * const destination, size_t const size_in_elements, char const * const source)
	{
		return __crt_state_management::wrapped_invoke(strcat_s, destination, size_in_elements, source);
	}
	int __cdecl _o_strcoll(const char * _string1, const char * _string2)
	{
		return __crt_state_management::wrapped_invoke(strcoll, _string1, _string2);
	}
	int __cdecl _o__strcoll_l(const char * _string1, const char * _string2, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strcoll_l, _string1, _string2, plocinfo);
	}
	errno_t __cdecl _o_strcpy_s(char * const destination, size_t const size_in_elements, char const * const source)
	{
		return __crt_state_management::wrapped_invoke(strcpy_s, destination, size_in_elements, source);
	}
	char * __cdecl _o__strdate(char * const buffer)
	{
		return __crt_state_management::wrapped_invoke(_strdate, buffer);
	}
	errno_t __cdecl _o__strdate_s(char * const buffer, size_t const size_in_chars)
	{
		return __crt_state_management::wrapped_invoke(_strdate_s, buffer, size_in_chars);
	}
	char * __cdecl _o__strdup(char const * const string)
	{
		return __crt_state_management::wrapped_invoke(_strdup, string);
	}
	char * __cdecl _o__strerror(char const * const message)
	{
		return __crt_state_management::wrapped_invoke(_strerror, message);
	}
	char * __cdecl _o_strerror(int const error_number)
	{
		return __crt_state_management::wrapped_invoke(strerror, error_number);
	}
	errno_t __cdecl _o__strerror_s(char * const buffer, size_t const buffer_count, char const * const message)
	{
		return __crt_state_management::wrapped_invoke(_strerror_s, buffer, buffer_count, message);
	}
	errno_t __cdecl _o_strerror_s(char * const buffer, size_t const buffer_count, int const error_number)
	{
		return __crt_state_management::wrapped_invoke(strerror_s, buffer, buffer_count, error_number);
	}
	size_t __cdecl _o__Strftime(char * const string, size_t const max_size, char const * const format, tm const * const timeptr, void * const lc_time_arg)
	{
		return __crt_state_management::wrapped_invoke(_Strftime, string, max_size, format, timeptr, lc_time_arg);
	}
	size_t __cdecl _o_strftime(char * const string, size_t const max_size, char const * const format, tm const * const timeptr)
	{
		return __crt_state_management::wrapped_invoke(strftime, string, max_size, format, timeptr);
	}
	size_t __cdecl _o__strftime_l(char * const string, size_t const max_size, char const * const format, tm const * const timeptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strftime_l, string, max_size, format, timeptr, locale);
	}
	int __cdecl _o__stricmp(char const * const lhs, char const * const rhs)
	{
		return __crt_state_management::wrapped_invoke(_stricmp, lhs, rhs);
	}
	int __cdecl _o__stricmp_l(char const * const lhs, char const * const rhs, _locale_t const plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_stricmp_l, lhs, rhs, plocinfo);
	}
	int __cdecl _o__stricoll(const char * _string1, const char * _string2)
	{
		return __crt_state_management::wrapped_invoke(_stricoll, _string1, _string2);
	}
	int __cdecl _o__stricoll_l(const char * _string1, const char * _string2, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_stricoll_l, _string1, _string2, plocinfo);
	}
	char * __cdecl _o__strlwr(char * string)
	{
		return __crt_state_management::wrapped_invoke(_strlwr, string);
	}
	char * __cdecl _o__strlwr_l(char * string, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strlwr_l, string, plocinfo);
	}
	errno_t __cdecl _o__strlwr_s(char * string, size_t sizeInBytes)
	{
		return __crt_state_management::wrapped_invoke(_strlwr_s, string, sizeInBytes);
	}
	errno_t __cdecl _o__strlwr_s_l(char * string, size_t sizeInBytes, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strlwr_s_l, string, sizeInBytes, plocinfo);
	}
	errno_t __cdecl _o_strncat_s(char * const destination, size_t const size_in_elements, char const * const source, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(strncat_s, destination, size_in_elements, source, count);
	}
	int __cdecl _o__strncoll(const char * _string1, const char * _string2, size_t count)
	{
		return __crt_state_management::wrapped_invoke(_strncoll, _string1, _string2, count);
	}
	int __cdecl _o__strncoll_l(const char * _string1, const char * _string2, size_t count, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strncoll_l, _string1, _string2, count, plocinfo);
	}
	errno_t __cdecl _o_strncpy_s(char * const destination, size_t const size_in_elements, char const * const source, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(strncpy_s, destination, size_in_elements, source, count);
	}
	int __cdecl _o__strnicmp(char const * const lhs, char const * const rhs, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(_strnicmp, lhs, rhs, count);
	}
	int __cdecl _o__strnicmp_l(char const * const lhs, char const * const rhs, size_t const count, _locale_t const plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strnicmp_l, lhs, rhs, count, plocinfo);
	}
	int __cdecl _o__strnicoll(const char * _string1, const char * _string2, size_t count)
	{
		return __crt_state_management::wrapped_invoke(_strnicoll, _string1, _string2, count);
	}
	int __cdecl _o__strnicoll_l(const char * _string1, const char * _string2, size_t count, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strnicoll_l, _string1, _string2, count, plocinfo);
	}
	errno_t __cdecl _o__strnset_s(char * const destination, size_t const size_in_elements, int const value, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(_strnset_s, destination, size_in_elements, value, count);
	}
	errno_t __cdecl _o__strset_s(char * const destination, size_t const size_in_elements, int const value)
	{
		return __crt_state_management::wrapped_invoke(_strset_s, destination, size_in_elements, value);
	}
	char * __cdecl _o__strtime(char * const buffer)
	{
		return __crt_state_management::wrapped_invoke(_strtime, buffer);
	}
	errno_t __cdecl _o__strtime_s(char * const buffer, size_t const size_in_chars)
	{
		return __crt_state_management::wrapped_invoke(_strtime_s, buffer, size_in_chars);
	}
	double __cdecl _o_strtod(char const * const string, char ** const end_ptr)
	{
		return __crt_state_management::wrapped_invoke(strtod, string, end_ptr);
	}
	double __cdecl _o__strtod_l(char const * const string, char ** const end_ptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtod_l, string, end_ptr, locale);
	}
	float __cdecl _o_strtof(char const * const string, char ** const end_ptr)
	{
		return __crt_state_management::wrapped_invoke(strtof, string, end_ptr);
	}
	float __cdecl _o__strtof_l(char const * const string, char ** const end_ptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtof_l, string, end_ptr, locale);
	}
	__int64 __cdecl _o__strtoi64(char const * const string, char ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(_strtoi64, string, end_ptr, base);
	}
	__int64 __cdecl _o__strtoi64_l(char const * const string, char ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtoi64_l, string, end_ptr, base, locale);
	}
	char * __cdecl _o_strtok(char * const string, char const * const control)
	{
		return __crt_state_management::wrapped_invoke(strtok, string, control);
	}
	char * __cdecl _o_strtok_s(char * string, char const * control, char ** context)
	{
		return __crt_state_management::wrapped_invoke(strtok_s, string, control, context);
	}
	long __cdecl _o_strtol(char const * const string, char ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(strtol, string, end_ptr, base);
	}
	long __cdecl _o__strtol_l(char const * const string, char ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtol_l, string, end_ptr, base, locale);
	}
	long double __cdecl _o_strtold(char const * const string, char ** const end_ptr)
	{
		return __crt_state_management::wrapped_invoke(strtold, string, end_ptr);
	}
	long double __cdecl _o__strtold_l(char const * const string, char ** const end_ptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtold_l, string, end_ptr, locale);
	}
	long long __cdecl _o_strtoll(char const * const string, char ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(strtoll, string, end_ptr, base);
	}
	long long __cdecl _o__strtoll_l(char const * const string, char ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtoll_l, string, end_ptr, base, locale);
	}
	unsigned __int64 __cdecl _o__strtoui64(char const * const string, char ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(_strtoui64, string, end_ptr, base);
	}
	unsigned __int64 __cdecl _o__strtoui64_l(char const * const string, char ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtoui64_l, string, end_ptr, base, locale);
	}
	unsigned long __cdecl _o_strtoul(char const * const string, char ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(strtoul, string, end_ptr, base);
	}
	unsigned long __cdecl _o__strtoul_l(char const * const string, char ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtoul_l, string, end_ptr, base, locale);
	}
	unsigned long long __cdecl _o_strtoull(char const * const string, char ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(strtoull, string, end_ptr, base);
	}
	unsigned long long __cdecl _o__strtoull_l(char const * const string, char ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_strtoull_l, string, end_ptr, base, locale);
	}
	char * __cdecl _o__strupr(char * string)
	{
		return __crt_state_management::wrapped_invoke(_strupr, string);
	}
	char * __cdecl _o__strupr_l(char * string, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strupr_l, string, plocinfo);
	}
	errno_t __cdecl _o__strupr_s(char * string, size_t sizeInBytes)
	{
		return __crt_state_management::wrapped_invoke(_strupr_s, string, sizeInBytes);
	}
	errno_t __cdecl _o__strupr_s_l(char * string, size_t sizeInBytes, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strupr_s_l, string, sizeInBytes, plocinfo);
	}
	size_t __cdecl _o__strxfrm_l(char * _string1, const char * _string2, size_t _count, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_strxfrm_l, _string1, _string2, _count, plocinfo);
	}
	void __cdecl _o__swab(char * source, char * destination, int bytes)
	{
		return __crt_state_management::wrapped_invoke_void(_swab, source, destination, bytes);
	}
	int __cdecl _o_system(char const * const command)
	{
		return __crt_state_management::wrapped_invoke(system, command);
	}
	long __cdecl _o__tell(int const fh)
	{
		return __crt_state_management::wrapped_invoke(_tell, fh);
	}
	__int64 __cdecl _o__telli64(int const fh)
	{
		return __crt_state_management::wrapped_invoke(_telli64, fh);
	}
	void __cdecl _o_terminate()
	{
		return __crt_state_management::wrapped_invoke_void(terminate);
	}
	int __cdecl _o__timespec32_get(_timespec32 * const ts, int const base)
	{
		return __crt_state_management::wrapped_invoke(_timespec32_get, ts, base);
	}
	int __cdecl _o__timespec64_get(_timespec64 * const ts, int const base)
	{
		return __crt_state_management::wrapped_invoke(_timespec64_get, ts, base);
	}
	long * __cdecl _o___timezone()
	{
		return __crt_state_management::wrapped_invoke(__timezone);
	}
	errno_t __cdecl _o_tmpfile_s(FILE ** const stream)
	{
		return __crt_state_management::wrapped_invoke(tmpfile_s, stream);
	}
	errno_t __cdecl _o_tmpnam_s(char * const result_buffer, size_t const result_buffer_count)
	{
		return __crt_state_management::wrapped_invoke(tmpnam_s, result_buffer, result_buffer_count);
	}
	int __cdecl _o_tolower(int const c)
	{
		return __crt_state_management::wrapped_invoke(tolower, c);
	}
	int __cdecl _o__tolower_l(int const c, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_tolower_l, c, locale);
	}
	int __cdecl _o_toupper(int const c)
	{
		return __crt_state_management::wrapped_invoke(toupper, c);
	}
	int __cdecl _o__toupper_l(int const c, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_toupper_l, c, locale);
	}
	wint_t __cdecl _o_towlower(wint_t c)
	{
		return __crt_state_management::wrapped_invoke(towlower, c);
	}
	wint_t __cdecl _o__towlower_l(wint_t c, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_towlower_l, c, plocinfo);
	}
	wint_t __cdecl _o_towupper(wint_t c)
	{
		return __crt_state_management::wrapped_invoke(towupper, c);
	}
	wint_t __cdecl _o__towupper_l(wint_t c, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_towupper_l, c, plocinfo);
	}
	char ** __cdecl _o___tzname()
	{
		return __crt_state_management::wrapped_invoke(__tzname);
	}
	void __cdecl _o__tzset()
	{
		return __crt_state_management::wrapped_invoke_void(_tzset);
	}
	char * __cdecl _o__ui64toa(unsigned __int64 const value, char * const buffer, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ui64toa, value, buffer, radix);
	}
	errno_t __cdecl _o__ui64toa_s(unsigned __int64 const value, char * const buffer, size_t const buffer_count, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ui64toa_s, value, buffer, buffer_count, radix);
	}
	wchar_t * __cdecl _o__ui64tow(unsigned __int64 const value, wchar_t * const buffer, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ui64tow, value, buffer, radix);
	}
	errno_t __cdecl _o__ui64tow_s(unsigned __int64 const value, wchar_t * const buffer, size_t const buffer_count, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ui64tow_s, value, buffer, buffer_count, radix);
	}
	char * __cdecl _o__ultoa(unsigned long const value, char * const buffer, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ultoa, value, buffer, radix);
	}
	errno_t __cdecl _o__ultoa_s(unsigned long const value, char * const buffer, size_t const buffer_count, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ultoa_s, value, buffer, buffer_count, radix);
	}
	wchar_t * __cdecl _o__ultow(unsigned long const value, wchar_t * const buffer, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ultow, value, buffer, radix);
	}
	errno_t __cdecl _o__ultow_s(unsigned long const value, wchar_t * const buffer, size_t const buffer_count, int const radix)
	{
		return __crt_state_management::wrapped_invoke(_ultow_s, value, buffer, buffer_count, radix);
	}
	int __cdecl _o__umask(int const mode)
	{
		return __crt_state_management::wrapped_invoke(_umask, mode);
	}
	errno_t __cdecl _o__umask_s(int const mode, int * const old_mode)
	{
		return __crt_state_management::wrapped_invoke(_umask_s, mode, old_mode);
	}
	int __cdecl _o_ungetc(int const c, FILE * const stream)
	{
		return __crt_state_management::wrapped_invoke(ungetc, c, stream);
	}
	int __cdecl _o__ungetc_nolock(int const c, FILE * public_stream)
	{
		return __crt_state_management::wrapped_invoke(_ungetc_nolock, c, public_stream);
	}
	int __cdecl _o__ungetch(int const c)
	{
		return __crt_state_management::wrapped_invoke(_ungetch, c);
	}
	int __cdecl _o__ungetch_nolock(int const c)
	{
		return __crt_state_management::wrapped_invoke(_ungetch_nolock, c);
	}
	wint_t __cdecl _o_ungetwc(wint_t const c, FILE * const stream)
	{
		return __crt_state_management::wrapped_invoke(ungetwc, c, stream);
	}
	wint_t __cdecl _o__ungetwc_nolock(wint_t const c, FILE * const public_stream)
	{
		return __crt_state_management::wrapped_invoke(_ungetwc_nolock, c, public_stream);
	}
	wint_t __cdecl _o__ungetwch(wint_t const c)
	{
		return __crt_state_management::wrapped_invoke(_ungetwch, c);
	}
	wint_t __cdecl _o__ungetwch_nolock(wint_t const c)
	{
		return __crt_state_management::wrapped_invoke(_ungetwch_nolock, c);
	}
	int __cdecl _o__unlink(char const * const path)
	{
		return __crt_state_management::wrapped_invoke(_unlink, path);
	}
	int __cdecl _o__unloaddll(intptr_t hMod)
	{
		return __crt_state_management::wrapped_invoke(_unloaddll, hMod);
	}
	void __cdecl _o__unlock_file(FILE * const stream)
	{
		return __crt_state_management::wrapped_invoke_void(_unlock_file, stream);
	}
	int __cdecl _o__utime32(char const * const file_name, __utimbuf32 * const times)
	{
		return __crt_state_management::wrapped_invoke(_utime32, file_name, times);
	}
	int __cdecl _o__utime64(char const * const file_name, __utimbuf64 * const times)
	{
		return __crt_state_management::wrapped_invoke(_utime64, file_name, times);
	}
	wchar_t * __cdecl _o__W_Getdays()
	{
		return __crt_state_management::wrapped_invoke(_W_Getdays);
	}
	wchar_t * __cdecl _o__W_Getmonths()
	{
		return __crt_state_management::wrapped_invoke(_W_Getmonths);
	}
	void * __cdecl _o__W_Gettnames()
	{
		return __crt_state_management::wrapped_invoke(_W_Gettnames);
	}
	int __cdecl _o__waccess(wchar_t const * const path, int const access_mode)
	{
		return __crt_state_management::wrapped_invoke(_waccess, path, access_mode);
	}
	errno_t __cdecl _o__waccess_s(wchar_t const * const path, int const access_mode)
	{
		return __crt_state_management::wrapped_invoke(_waccess_s, path, access_mode);
	}
	wchar_t * __cdecl _o__wasctime(tm const * const tm_value)
	{
		return __crt_state_management::wrapped_invoke(_wasctime, tm_value);
	}
	errno_t __cdecl _o__wasctime_s(wchar_t * const buffer, size_t const size_in_chars, tm const * const tm_value)
	{
		return __crt_state_management::wrapped_invoke(_wasctime_s, buffer, size_in_chars, tm_value);
	}
	int __cdecl _o__wchdir(wchar_t const * const path)
	{
		return __crt_state_management::wrapped_invoke(_wchdir, path);
	}
	int __cdecl _o__wchmod(wchar_t const * const path, int const mode)
	{
		return __crt_state_management::wrapped_invoke(_wchmod, path, mode);
	}
	int __cdecl _o__wcreat(wchar_t const * const path, int const pmode)
	{
		return __crt_state_management::wrapped_invoke(_wcreat, path, pmode);
	}
	_locale_t __cdecl _o__wcreate_locale(int _category, const wchar_t * locale)
	{
		return __crt_state_management::wrapped_invoke(_wcreate_locale, _category, locale);
	}
	size_t __cdecl _o_wcrtomb(char * const destination, wchar_t const wchar, mbstate_t * const state)
	{
		return __crt_state_management::wrapped_invoke(wcrtomb, destination, wchar, state);
	}
	errno_t __cdecl _o_wcrtomb_s(size_t * const return_value, char * const destination, size_t const destination_count, wchar_t const wchar, mbstate_t * const state)
	{
		return __crt_state_management::wrapped_invoke(wcrtomb_s, return_value, destination, destination_count, wchar, state);
	}
	errno_t __cdecl _o_wcscat_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const * const source)
	{
		return __crt_state_management::wrapped_invoke(wcscat_s, destination, size_in_elements, source);
	}
	int __cdecl _o_wcscoll(const wchar_t * _string1, const wchar_t * _string2)
	{
		return __crt_state_management::wrapped_invoke(wcscoll, _string1, _string2);
	}
	int __cdecl _o__wcscoll_l(const wchar_t * _string1, const wchar_t * _string2, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcscoll_l, _string1, _string2, plocinfo);
	}
	wchar_t * __cdecl _o_wcscpy(wchar_t * const destination, wchar_t const * source)
	{
		return __crt_state_management::wrapped_invoke(wcscpy, destination, source);
	}
	errno_t __cdecl _o_wcscpy_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const * const source)
	{
		return __crt_state_management::wrapped_invoke(wcscpy_s, destination, size_in_elements, source);
	}
	wchar_t * __cdecl _o__wcsdup(wchar_t const * const string)
	{
		return __crt_state_management::wrapped_invoke(_wcsdup, string);
	}
	wchar_t * __cdecl _o___wcserror(wchar_t const * const message)
	{
		return __crt_state_management::wrapped_invoke(__wcserror, message);
	}
	wchar_t * __cdecl _o__wcserror(int const error_number)
	{
		return __crt_state_management::wrapped_invoke(_wcserror, error_number);
	}
	errno_t __cdecl _o__wcserror_s(wchar_t * const buffer, size_t const buffer_count, int const error_number)
	{
		return __crt_state_management::wrapped_invoke(_wcserror_s, buffer, buffer_count, error_number);
	}
	size_t __cdecl _o__Wcsftime(wchar_t * const buffer, size_t const max_size, wchar_t const * const format, tm const * const timeptr, void * const lc_time_arg)
	{
		return __crt_state_management::wrapped_invoke(_Wcsftime, buffer, max_size, format, timeptr, lc_time_arg);
	}
	size_t __cdecl _o_wcsftime(wchar_t * const buffer, size_t const max_size, wchar_t const * const format, tm const * const timeptr)
	{
		return __crt_state_management::wrapped_invoke(wcsftime, buffer, max_size, format, timeptr);
	}
	size_t __cdecl _o__wcsftime_l(wchar_t * const buffer, size_t const max_size, wchar_t const * const format, tm const * const timeptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcsftime_l, buffer, max_size, format, timeptr, locale);
	}
	int __cdecl _o__wcsicmp(wchar_t const * const lhs, wchar_t const * const rhs)
	{
		return __crt_state_management::wrapped_invoke(_wcsicmp, lhs, rhs);
	}
	int __cdecl _o__wcsicmp_l(wchar_t const * const lhs, wchar_t const * const rhs, _locale_t const plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsicmp_l, lhs, rhs, plocinfo);
	}
	int __cdecl _o__wcsicoll(const wchar_t * _string1, const wchar_t * _string2)
	{
		return __crt_state_management::wrapped_invoke(_wcsicoll, _string1, _string2);
	}
	int __cdecl _o__wcsicoll_l(const wchar_t * _string1, const wchar_t * _string2, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsicoll_l, _string1, _string2, plocinfo);
	}
	wchar_t * __cdecl _o__wcslwr(wchar_t * wsrc)
	{
		return __crt_state_management::wrapped_invoke(_wcslwr, wsrc);
	}
	wchar_t * __cdecl _o__wcslwr_l(wchar_t * wsrc, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcslwr_l, wsrc, plocinfo);
	}
	errno_t __cdecl _o__wcslwr_s(wchar_t * wsrc, size_t sizeInWords)
	{
		return __crt_state_management::wrapped_invoke(_wcslwr_s, wsrc, sizeInWords);
	}
	errno_t __cdecl _o__wcslwr_s_l(wchar_t * wsrc, size_t sizeInWords, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcslwr_s_l, wsrc, sizeInWords, plocinfo);
	}
	errno_t __cdecl _o_wcsncat_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const * const source, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(wcsncat_s, destination, size_in_elements, source, count);
	}
	int __cdecl _o__wcsncoll(const wchar_t * _string1, const wchar_t * _string2, size_t count)
	{
		return __crt_state_management::wrapped_invoke(_wcsncoll, _string1, _string2, count);
	}
	int __cdecl _o__wcsncoll_l(const wchar_t * _string1, const wchar_t * _string2, size_t count, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsncoll_l, _string1, _string2, count, plocinfo);
	}
	errno_t __cdecl _o_wcsncpy_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const * const source, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(wcsncpy_s, destination, size_in_elements, source, count);
	}
	int __cdecl _o__wcsnicmp(wchar_t const * const lhs, wchar_t const * const rhs, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(_wcsnicmp, lhs, rhs, count);
	}
	int __cdecl _o__wcsnicmp_l(wchar_t const * const lhs, wchar_t const * const rhs, size_t const count, _locale_t const plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsnicmp_l, lhs, rhs, count, plocinfo);
	}
	int __cdecl _o__wcsnicoll(const wchar_t * _string1, const wchar_t * _string2, size_t count)
	{
		return __crt_state_management::wrapped_invoke(_wcsnicoll, _string1, _string2, count);
	}
	int __cdecl _o__wcsnicoll_l(const wchar_t * _string1, const wchar_t * _string2, size_t count, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsnicoll_l, _string1, _string2, count, plocinfo);
	}
	wchar_t * __cdecl _o__wcsnset(wchar_t * const string, wchar_t const value, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(_wcsnset, string, value, count);
	}
	errno_t __cdecl _o__wcsnset_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const value, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(_wcsnset_s, destination, size_in_elements, value, count);
	}
	size_t __cdecl _o_wcsrtombs(char * const destination, wchar_t const ** const source, size_t const n, mbstate_t * const state)
	{
		return __crt_state_management::wrapped_invoke(wcsrtombs, destination, source, n, state);
	}
	errno_t __cdecl _o_wcsrtombs_s(size_t * const return_value, char * const destination, size_t const destination_count, wchar_t const ** const source, size_t const n, mbstate_t * const state)
	{
		return __crt_state_management::wrapped_invoke(wcsrtombs_s, return_value, destination, destination_count, source, n, state);
	}
	wchar_t * __cdecl _o__wcsset(wchar_t * const string, wchar_t const value)
	{
		return __crt_state_management::wrapped_invoke(_wcsset, string, value);
	}
	errno_t __cdecl _o__wcsset_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const value)
	{
		return __crt_state_management::wrapped_invoke(_wcsset_s, destination, size_in_elements, value);
	}
	double __cdecl _o_wcstod(wchar_t const * const string, wchar_t ** const end_ptr)
	{
		return __crt_state_management::wrapped_invoke(wcstod, string, end_ptr);
	}
	double __cdecl _o__wcstod_l(wchar_t const * const string, wchar_t ** const end_ptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstod_l, string, end_ptr, locale);
	}
	float __cdecl _o_wcstof(wchar_t const * const string, wchar_t ** const end_ptr)
	{
		return __crt_state_management::wrapped_invoke(wcstof, string, end_ptr);
	}
	float __cdecl _o__wcstof_l(wchar_t const * const string, wchar_t ** const end_ptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstof_l, string, end_ptr, locale);
	}
	__int64 __cdecl _o__wcstoi64(wchar_t const * const string, wchar_t ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(_wcstoi64, string, end_ptr, base);
	}
	__int64 __cdecl _o__wcstoi64_l(wchar_t const * const string, wchar_t ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstoi64_l, string, end_ptr, base, locale);
	}
	wchar_t * __cdecl _o_wcstok(wchar_t * const string, wchar_t const * const control, wchar_t ** const context)
	{
		return __crt_state_management::wrapped_invoke(wcstok, string, control, context);
	}
	wchar_t * __cdecl _o_wcstok_s(wchar_t * const string, wchar_t const * const control, wchar_t ** const context)
	{
		return __crt_state_management::wrapped_invoke(wcstok_s, string, control, context);
	}
	long __cdecl _o_wcstol(wchar_t const * const string, wchar_t ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(wcstol, string, end_ptr, base);
	}
	long __cdecl _o__wcstol_l(wchar_t const * const string, wchar_t ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstol_l, string, end_ptr, base, locale);
	}
	long double __cdecl _o_wcstold(wchar_t const * const string, wchar_t ** const end_ptr)
	{
		return __crt_state_management::wrapped_invoke(wcstold, string, end_ptr);
	}
	long double __cdecl _o__wcstold_l(wchar_t const * const string, wchar_t ** const end_ptr, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstold_l, string, end_ptr, locale);
	}
	long long __cdecl _o_wcstoll(wchar_t const * const string, wchar_t ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(wcstoll, string, end_ptr, base);
	}
	long long __cdecl _o__wcstoll_l(wchar_t const * const string, wchar_t ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstoll_l, string, end_ptr, base, locale);
	}
	size_t __cdecl _o_wcstombs(char * s, const wchar_t * pwcs, size_t n)
	{
		return __crt_state_management::wrapped_invoke(wcstombs, s, pwcs, n);
	}
	size_t __cdecl _o__wcstombs_l(char * s, const wchar_t * pwcs, size_t n, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcstombs_l, s, pwcs, n, plocinfo);
	}
	errno_t __cdecl _o_wcstombs_s(size_t * pConvertedChars, char * dst, size_t sizeInBytes, const wchar_t * src, size_t n)
	{
		return __crt_state_management::wrapped_invoke(wcstombs_s, pConvertedChars, dst, sizeInBytes, src, n);
	}
	errno_t __cdecl _o__wcstombs_s_l(size_t * pConvertedChars, char * dst, size_t sizeInBytes, const wchar_t * src, size_t n, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcstombs_s_l, pConvertedChars, dst, sizeInBytes, src, n, plocinfo);
	}
	unsigned __int64 __cdecl _o__wcstoui64(wchar_t const * const string, wchar_t ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(_wcstoui64, string, end_ptr, base);
	}
	unsigned __int64 __cdecl _o__wcstoui64_l(wchar_t const * const string, wchar_t ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstoui64_l, string, end_ptr, base, locale);
	}
	unsigned long __cdecl _o_wcstoul(wchar_t const * const string, wchar_t ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(wcstoul, string, end_ptr, base);
	}
	unsigned long __cdecl _o__wcstoul_l(wchar_t const * const string, wchar_t ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstoul_l, string, end_ptr, base, locale);
	}
	unsigned long long __cdecl _o_wcstoull(wchar_t const * const string, wchar_t ** const end_ptr, int const base)
	{
		return __crt_state_management::wrapped_invoke(wcstoull, string, end_ptr, base);
	}
	unsigned long long __cdecl _o__wcstoull_l(wchar_t const * const string, wchar_t ** const end_ptr, int const base, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wcstoull_l, string, end_ptr, base, locale);
	}
	wchar_t * __cdecl _o__wcsupr(wchar_t * wsrc)
	{
		return __crt_state_management::wrapped_invoke(_wcsupr, wsrc);
	}
	wchar_t * __cdecl _o__wcsupr_l(wchar_t * wsrc, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsupr_l, wsrc, plocinfo);
	}
	errno_t __cdecl _o__wcsupr_s(wchar_t * wsrc, size_t sizeInWords)
	{
		return __crt_state_management::wrapped_invoke(_wcsupr_s, wsrc, sizeInWords);
	}
	errno_t __cdecl _o__wcsupr_s_l(wchar_t * wsrc, size_t sizeInWords, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsupr_s_l, wsrc, sizeInWords, plocinfo);
	}
	size_t __cdecl _o__wcsxfrm_l(wchar_t * _string1, const wchar_t * _string2, size_t _count, _locale_t plocinfo)
	{
		return __crt_state_management::wrapped_invoke(_wcsxfrm_l, _string1, _string2, _count, plocinfo);
	}
	wchar_t * __cdecl _o__wctime32(__time32_t const * const time_t_value)
	{
		return __crt_state_management::wrapped_invoke(_wctime32, time_t_value);
	}
	errno_t __cdecl _o__wctime32_s(wchar_t * const buffer, size_t const size_in_chars, __time32_t const * const time_t_value)
	{
		return __crt_state_management::wrapped_invoke(_wctime32_s, buffer, size_in_chars, time_t_value);
	}
	wchar_t * __cdecl _o__wctime64(__time64_t const * const time_t_value)
	{
		return __crt_state_management::wrapped_invoke(_wctime64, time_t_value);
	}
	errno_t __cdecl _o__wctime64_s(wchar_t * const buffer, size_t const size_in_chars, __time64_t const * const time_t_value)
	{
		return __crt_state_management::wrapped_invoke(_wctime64_s, buffer, size_in_chars, time_t_value);
	}
	int __cdecl _o_wctob(wint_t const wchar)
	{
		return __crt_state_management::wrapped_invoke(wctob, wchar);
	}
	int __cdecl _o_wctomb(char * const destination, wchar_t const wchar)
	{
		return __crt_state_management::wrapped_invoke(wctomb, destination, wchar);
	}
	int __cdecl _o__wctomb_l(char * const destination, wchar_t const wchar, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wctomb_l, destination, wchar, locale);
	}
	errno_t __cdecl _o_wctomb_s(int * const return_value, char * const destination, size_t const destination_count, wchar_t const wchar)
	{
		return __crt_state_management::wrapped_invoke(wctomb_s, return_value, destination, destination_count, wchar);
	}
	int __cdecl _o__wctomb_s_l(int * const return_value, char * const destination, size_t const destination_count, wchar_t const wchar, _locale_t const locale)
	{
		return __crt_state_management::wrapped_invoke(_wctomb_s_l, return_value, destination, destination_count, wchar, locale);
	}
	errno_t __cdecl _o__wdupenv_s(wchar_t ** const buffer_pointer, size_t * const buffer_count, wchar_t const * const name)
	{
		return __crt_state_management::wrapped_invoke(_wdupenv_s, buffer_pointer, buffer_count, name);
	}
	intptr_t __cdecl _o__wexecv(wchar_t const * const file_name, wchar_t const * const * const arguments)
	{
		return __crt_state_management::wrapped_invoke(_wexecv, file_name, arguments);
	}
	intptr_t __cdecl _o__wexecve(wchar_t const * const file_name, wchar_t const * const * const arguments, wchar_t const * const * const environment)
	{
		return __crt_state_management::wrapped_invoke(_wexecve, file_name, arguments, environment);
	}
	intptr_t __cdecl _o__wexecvp(wchar_t const * const file_name, wchar_t const * const * const arguments)
	{
		return __crt_state_management::wrapped_invoke(_wexecvp, file_name, arguments);
	}
	intptr_t __cdecl _o__wexecvpe(wchar_t const * const file_name, wchar_t const * const * const arguments, wchar_t const * const * const environment)
	{
		return __crt_state_management::wrapped_invoke(_wexecvpe, file_name, arguments, environment);
	}
	FILE * __cdecl _o__wfdopen(int const fh, wchar_t const * const mode)
	{
		return __crt_state_management::wrapped_invoke(_wfdopen, fh, mode);
	}
	intptr_t __cdecl _o__wfindfirst32(wchar_t const * const pattern, _wfinddata32_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindfirst32, pattern, result);
	}
	intptr_t __cdecl _o__wfindfirst32i64(wchar_t const * const pattern, _wfinddata32i64_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindfirst32i64, pattern, result);
	}
	intptr_t __cdecl _o__wfindfirst64(wchar_t const * const pattern, _wfinddata64_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindfirst64, pattern, result);
	}
	intptr_t __cdecl _o__wfindfirst64i32(wchar_t const * const pattern, _wfinddata64i32_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindfirst64i32, pattern, result);
	}
	int __cdecl _o__wfindnext32(intptr_t const handle, _wfinddata32_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindnext32, handle, result);
	}
	int __cdecl _o__wfindnext32i64(intptr_t const handle, _wfinddata32i64_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindnext32i64, handle, result);
	}
	int __cdecl _o__wfindnext64(intptr_t const handle, _wfinddata64_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindnext64, handle, result);
	}
	int __cdecl _o__wfindnext64i32(intptr_t const handle, _wfinddata64i32_t * const result)
	{
		return __crt_state_management::wrapped_invoke(_wfindnext64i32, handle, result);
	}
	FILE * __cdecl _o__wfopen(wchar_t const * const file, wchar_t const * const mode)
	{
		return __crt_state_management::wrapped_invoke(_wfopen, file, mode);
	}
	errno_t __cdecl _o__wfopen_s(FILE ** const result, wchar_t const * const file, wchar_t const * const mode)
	{
		return __crt_state_management::wrapped_invoke(_wfopen_s, result, file, mode);
	}
	FILE * __cdecl _o__wfreopen(wchar_t const * const file_name, wchar_t const * const mode, FILE * const public_stream)
	{
		return __crt_state_management::wrapped_invoke(_wfreopen, file_name, mode, public_stream);
	}
	errno_t __cdecl _o__wfreopen_s(FILE ** const result, wchar_t const * const file_name, wchar_t const * const mode, FILE * const public_stream)
	{
		return __crt_state_management::wrapped_invoke(_wfreopen_s, result, file_name, mode, public_stream);
	}
	FILE * __cdecl _o__wfsopen(wchar_t const * const file, wchar_t const * const mode, int const share_flag)
	{
		return __crt_state_management::wrapped_invoke(_wfsopen, file, mode, share_flag);
	}
	wchar_t * __cdecl _o__wfullpath(wchar_t * const user_buffer, wchar_t const * const path, size_t const max_count)
	{
		return __crt_state_management::wrapped_invoke(_wfullpath, user_buffer, path, max_count);
	}
	wchar_t * __cdecl _o__wgetcwd(wchar_t * const user_buffer, int const max_length)
	{
		return __crt_state_management::wrapped_invoke(_wgetcwd, user_buffer, max_length);
	}
	wchar_t * __cdecl _o__wgetdcwd(int const drive_number, wchar_t * const user_buffer, int const max_length)
	{
		return __crt_state_management::wrapped_invoke(_wgetdcwd, drive_number, user_buffer, max_length);
	}
	wchar_t * __cdecl _o__wgetenv(wchar_t const * const name)
	{
		return __crt_state_management::wrapped_invoke(_wgetenv, name);
	}
	errno_t __cdecl _o__wgetenv_s(size_t * const required_count, wchar_t * const buffer, size_t const buffer_count, wchar_t const * const name)
	{
		return __crt_state_management::wrapped_invoke(_wgetenv_s, required_count, buffer, buffer_count, name);
	}
	void __cdecl _o__wmakepath(wchar_t * const result_buffer, wchar_t const * const drive, wchar_t const * const directory, wchar_t const * const file_name, wchar_t const * const extension)
	{
		return __crt_state_management::wrapped_invoke_void(_wmakepath, result_buffer, drive, directory, file_name, extension);
	}
	errno_t __cdecl _o__wmakepath_s(wchar_t * const result_buffer, size_t const result_count, wchar_t const * const drive, wchar_t const * const directory, wchar_t const * const file_name, wchar_t const * const extension)
	{
		return __crt_state_management::wrapped_invoke(_wmakepath_s, result_buffer, result_count, drive, directory, file_name, extension);
	}
	errno_t __cdecl _o_wmemcpy_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const * const source, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(wmemcpy_s, destination, size_in_elements, source, count);
	}
	errno_t __cdecl _o_wmemmove_s(wchar_t * const destination, size_t const size_in_elements, wchar_t const * const source, size_t const count)
	{
		return __crt_state_management::wrapped_invoke(wmemmove_s, destination, size_in_elements, source, count);
	}
	int __cdecl _o__wmkdir(wchar_t const * const path)
	{
		return __crt_state_management::wrapped_invoke(_wmkdir, path);
	}
	wchar_t * __cdecl _o__wmktemp(wchar_t * const template_string)
	{
		return __crt_state_management::wrapped_invoke(_wmktemp, template_string);
	}
	errno_t __cdecl _o__wmktemp_s(wchar_t * const template_string, size_t const buffer_size_in_chars)
	{
		return __crt_state_management::wrapped_invoke(_wmktemp_s, template_string, buffer_size_in_chars);
	}
	void __cdecl _o__wperror(wchar_t const * const wide_user_prefix)
	{
		return __crt_state_management::wrapped_invoke_void(_wperror, wide_user_prefix);
	}
	FILE * __cdecl _o__wpopen(wchar_t const * const command, wchar_t const * const type)
	{
		return __crt_state_management::wrapped_invoke(_wpopen, command, type);
	}
	int __cdecl _o__wputenv(wchar_t const * const option)
	{
		return __crt_state_management::wrapped_invoke(_wputenv, option);
	}
	errno_t __cdecl _o__wputenv_s(wchar_t const * const name, wchar_t const * const value)
	{
		return __crt_state_management::wrapped_invoke(_wputenv_s, name, value);
	}
	int __cdecl _o__wremove(wchar_t const * const path)
	{
		return __crt_state_management::wrapped_invoke(_wremove, path);
	}
	int __cdecl _o__wrename(wchar_t const * const old_name, wchar_t const * const new_name)
	{
		return __crt_state_management::wrapped_invoke(_wrename, old_name, new_name);
	}
	int __cdecl _o__write(int const fh, void const * const buffer, unsigned const size)
	{
		return __crt_state_management::wrapped_invoke(_write, fh, buffer, size);
	}
	int __cdecl _o__wrmdir(wchar_t const * const path)
	{
		return __crt_state_management::wrapped_invoke(_wrmdir, path);
	}
	void __cdecl _o__wsearchenv(wchar_t const * const file_name, wchar_t const * const environment_variable, wchar_t * const result_buffer)
	{
		return __crt_state_management::wrapped_invoke_void(_wsearchenv, file_name, environment_variable, result_buffer);
	}
	errno_t __cdecl _o__wsearchenv_s(wchar_t const * const file_name, wchar_t const * const environment_variable, wchar_t * const result_buffer, size_t const result_count)
	{
		return __crt_state_management::wrapped_invoke(_wsearchenv_s, file_name, environment_variable, result_buffer, result_count);
	}
	wchar_t * __cdecl _o__wsetlocale(int _category, const wchar_t * _wlocale)
	{
		return __crt_state_management::wrapped_invoke(_wsetlocale, _category, _wlocale);
	}
	errno_t __cdecl _o__wsopen_dispatch(wchar_t const * const path, int const oflag, int const shflag, int const pmode, int * const pfh, int const secure)
	{
		return __crt_state_management::wrapped_invoke(_wsopen_dispatch, path, oflag, shflag, pmode, pfh, secure);
	}
	errno_t __cdecl _o__wsopen_s(int * const pfh, wchar_t const * const path, int const oflag, int const shflag, int const pmode)
	{
		return __crt_state_management::wrapped_invoke(_wsopen_s, pfh, path, oflag, shflag, pmode);
	}
	intptr_t __cdecl _o__wspawnv(int const mode, wchar_t const * const file_name, wchar_t const * const * const arguments)
	{
		return __crt_state_management::wrapped_invoke(_wspawnv, mode, file_name, arguments);
	}
	intptr_t __cdecl _o__wspawnve(int const mode, wchar_t const * const file_name, wchar_t const * const * const arguments, wchar_t const * const * const environment)
	{
		return __crt_state_management::wrapped_invoke(_wspawnve, mode, file_name, arguments, environment);
	}
	intptr_t __cdecl _o__wspawnvp(int const mode, wchar_t const * const file_name, wchar_t const * const * const arguments)
	{
		return __crt_state_management::wrapped_invoke(_wspawnvp, mode, file_name, arguments);
	}
	intptr_t __cdecl _o__wspawnvpe(int const mode, wchar_t const * const file_name, wchar_t const * const * const arguments, wchar_t const * const * const environment)
	{
		return __crt_state_management::wrapped_invoke(_wspawnvpe, mode, file_name, arguments, environment);
	}
	void __cdecl _o__wsplitpath(wchar_t const * const path, wchar_t * const drive, wchar_t * const directory, wchar_t * const file_name, wchar_t * const extension)
	{
		return __crt_state_management::wrapped_invoke_void(_wsplitpath, path, drive, directory, file_name, extension);
	}
	errno_t __cdecl _o__wsplitpath_s(wchar_t const * const path, wchar_t * const drive, size_t const drive_count, wchar_t * const directory, size_t const directory_count, wchar_t * const file_name, size_t const file_name_count, wchar_t * const extension, size_t const extension_count)
	{
	...
	unsigned char * __cdecl _o__mbsnbcat(
		unsigned char *dst,
	...
	unsigned char * __cdecl _o__mbsnbcpy(
		unsigned char *dst,
		const unsigned char *src,
		size_t cnt
	)
	...
	unsigned char * __cdecl _o__mbsncat(
		unsigned char *dst,
		const unsigned char *src,
		size_t cnt
	)
	...
	unsigned char * __cdecl _o__mbsncpy(
		unsigned char *dst,
		const unsigned char *src,
		size_t cnt
	)
	...
	unsigned char * __cdecl _o__mbsset(
		unsigned char *string,
		unsigned int val
	)
	{
	...
	unsigned char * __cdecl _o__mbsupr(
		unsigned char *string
	)
	{
		return __crt_state_management::wrapped_invoke(_mbsupr, string);
	}
	unsigned char * __cdecl _o__mbsupr_l(
		unsigned char *string,
		_locale_t plocinfo
	)
	{
	...
	//misc
	int __cdecl _o__purecall(void)
	{
		return __crt_state_management::wrapped_invoke(_purecall);
	}
	void* __cdecl _o_memset(void* _Dst, int _Val, size_t _Size)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIsin(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIcos(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CItan(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIsinh(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIcosh(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CItanh(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIasin(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIacos(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIatan(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIatan2(double x, double y)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIexp(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIlog(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIlog10(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIpow(double x, double y)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIsqrt(double x)
	{
	 ...
	 * @implemented
	 */
	double	CDECL	_o__CIfmod(double x, double y)
	{
	...
	double __cdecl _o__except1(DWORD fpe, _FP_OPERATION_CODE op, double arg, double res, DWORD cw, void * unk)
	{
		return __crt_state_management::wrapped_invoke(_except1, fpe, op, arg, res, cw, unk);
	}

	void __cdecl _o___std_exception_copy(__std_exception_data const* _From, __std_exception_data* _To)
	{
		return __crt_state_management::wrapped_invoke_void(__std_exception_copy, _From, _To);
	}
	void __cdecl _o___std_exception_destroy(__std_exception_data* _Data)
	{
		return __crt_state_management::wrapped_invoke_void(__std_exception_destroy, _Data);
	}

	//type_info
	void __cdecl _o___std_type_info_destroy_list(__type_info_node* _RootNode)
	{
		return __crt_state_management::wrapped_invoke_void(__std_type_info_destroy_list, _RootNode);
	}
	const char* __cdecl _o___std_type_info_name(__std_type_info_data* _Data, __type_info_node* _RootNod)
	{
