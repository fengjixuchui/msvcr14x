...
extern "C" FILE* __cdecl obsoleted__acrt_iob_func(unsigned const id)
{
...
extern "C" void __cdecl obsoleted_lock_file(FILE* const stream)
{
...
extern "C" void __cdecl obsoleted_unlock_file(FILE* const stream)
{
